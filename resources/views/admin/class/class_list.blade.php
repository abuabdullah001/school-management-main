  ...
  <div class="col-md-10 col-sm-12 col-lg-11">
      ...
      <div class="card-header">
                ...
                <div class="form-group col-md-3 col-lg-3 col-sm-12">
                    ...
                    <input type="text" class="form-control" value= "{{ Request::get('name') }}" id="exampleInputEmail1" placeholder=" Enter  class name" name="name"  required>
                  </div>
                ...
                <table class="table table-striped">
                  ...
                  @foreach($getrecord as $value)
                     <tr>
                      ...
                      <td>
                        <a href="{{ url('class_edit/'.$value->id) }}" class="btn btn-primary w">Edit</a>
                        <a href="{{ url('class_delete/'.$value->id) }}" onClick="return confirm('Are you sure to delete it?')" class="btn btn-danger">Delete</a>
                      </td>
                     </tr>
