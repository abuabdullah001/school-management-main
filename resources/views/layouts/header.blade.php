  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        @if(Auth::user()->role==1)
        <li class="nav-item">
            <a href="{{url('/dashboard_admin')}}" class="nav-link @if(Request::segment(2)=='dashboard_admin') active @endif">
        ...
        <li class="nav-item">
            <a href="{{url('/teacher_dashboard')}}" class="nav-link @if(Request::segment(1)=='teacher_dashboard') active @endif">
            <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Dashboard
